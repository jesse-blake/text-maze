...
module.exports = {
    ...
    randomBrightWebColor: function() {
        var brights = ['aqua','blue','blueviolet','chartreuse','cornflowerblue','crimson','cyan','darkturquoise','darkviolet','deeppink','deepskyblue','dodgerblue','fuchsia','gold','greenyellow','hotpink','lawngreen','lightseagreen','lightskyblue','lime','mediumorchid','mediumslateblue','mediumspringgreen','mediumvioletred','orange','red','royalblue','skyblue','springgreen','tomato','turquoise','violet','yellow'];
