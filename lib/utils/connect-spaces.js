...
module.exports = function(maze, charlist) {
    ...
    // Cells in the space Character from loIdx to hiIdx indicate which part
    ...
    // 'true' indicates a cell in a space Character connected in the maze.
    var connections;
    ...
    for (i = 0; i < charlist.length; i++) {
        if (charlist[i].ch === ' ') {
            ...
            // Examine each cell in the space Character to determine if it is connected
